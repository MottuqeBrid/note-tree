    ...
    return (
      <ResponsiveWrapper className={className}>
        ...
        >
          ...
          {/* Title */}
          <div className="absolute left-[180px] top-[620px] w-[580px] text-start">
            <h2
          ...
          {/* Meta */}
          <div className="absolute left-[210px] top-[880px] space-y-4 text-[30px] font-medium text-slate-600">
            <p>
